class IndividualsController < ApplicationController
  ...
  private
    ...
    def individual_params
      params.require(:individual).permit(:name_last, :name_first, :name_middle, :name_maiden, :name_familiar, :gender, :date_birth, :date_death, :place_birth, :cause_death, :misc_notes)
    end
end
